...
public class ActivityIntroBindingImpl extends ActivityIntroBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ivIntro, 1);
        sViewsWithIds.put(R.id.txtWelcome, 2);
        sViewsWithIds.put(R.id.txtSubtitle, 3);
        sViewsWithIds.put(R.id.txtSelectLang, 4);
        sViewsWithIds.put(R.id.btnEnglish, 5);
        sViewsWithIds.put(R.id.btnArabic, 6);
    }
    // views
    @NonNull
